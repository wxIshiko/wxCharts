...
$(_builddir)wxcharts_wxchartcategoricalaxis.o: src/wxchartcategoricalaxis.cpp
	$(CXX) -c -o $@ $(CPPFLAGS) $(CXXFLAGS) -MD -MP -fPIC -DPIC -pthread -Iinclude/wx/charts `wx-config --cxxflags --libs` src/wxchartcategoricalaxis.cpp
...
$(_builddir)wxcharts_wxcharttimeaxis.o: src/wxcharttimeaxis.cpp
	$(CXX) -c -o $@ $(CPPFLAGS) $(CXXFLAGS) -MD -MP -fPIC -DPIC -pthread -Iinclude/wx/charts `wx-config --cxxflags --libs` src/wxcharttimeaxis.cpp
...
$(_builddir)wxcharts_wxtimeserieschartoptions.o: src/wxtimeserieschartoptions.cpp
	$(CXX) -c -o $@ $(CPPFLAGS) $(CXXFLAGS) -MD -MP -fPIC -DPIC -pthread -Iinclude/wx/charts `wx-config --cxxflags --libs` src/wxtimeserieschartoptions.cpp

$(_builddir)wxcharts_wxtimeserieschart.o: src/wxtimeserieschart.cpp
	$(CXX) -c -o $@ $(CPPFLAGS) $(CXXFLAGS) -MD -MP -fPIC -DPIC -pthread -Iinclude/wx/charts `wx-config --cxxflags --libs` src/wxtimeserieschart.cpp

$(_builddir)wxcharts_wxtimeserieschartctrl.o: src/wxtimeserieschartctrl.cpp
	$(CXX) -c -o $@ $(CPPFLAGS) $(CXXFLAGS) -MD -MP -fPIC -DPIC -pthread -Iinclude/wx/charts `wx-config --cxxflags --libs` src/wxtimeserieschartctrl.cpp
