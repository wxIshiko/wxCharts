...
$(_builddir)wxcharts_wxcharstelement.o: src/wxcharstelement.cpp
	$(CXX) -c -o $@ $(CPPFLAGS) $(CXXFLAGS) -MD -MP -fPIC -DPIC -pthread -Iinclude/wx/charts -std=c++11 `wx-config --cxxflags --libs` src/wxcharstelement.cpp
