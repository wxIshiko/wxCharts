...
$(_builddir)wxcharts_wxchartlabelgroupoptions.o: src/wxchartlabelgroupoptions.cpp
	$(CXX) -c -o $@ $(CPPFLAGS) $(CXXFLAGS) -MD -MP -fPIC -DPIC -pthread -Iinclude/wx/charts `wx-config --cxxflags --libs` src/wxchartlabelgroupoptions.cpp
