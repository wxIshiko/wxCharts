...
$(_builddir)wxcharts_wxhistogramchartoptions.o: src/wxhistogramchartoptions.cpp
	$(CXX) -c -o $@ $(CPPFLAGS) $(CXXFLAGS) -MD -MP -fPIC -DPIC -pthread -Iinclude/wx/charts -std=c++11 `wx-config --cxxflags --libs` src/wxhistogramchartoptions.cpp

$(_builddir)wxcharts_wxhistogramchart.o: src/wxhistogramchart.cpp
	$(CXX) -c -o $@ $(CPPFLAGS) $(CXXFLAGS) -MD -MP -fPIC -DPIC -pthread -Iinclude/wx/charts -std=c++11 `wx-config --cxxflags --libs` src/wxhistogramchart.cpp

$(_builddir)wxcharts_wxhistogramchartctrl.o: src/wxhistogramchartctrl.cpp
	$(CXX) -c -o $@ $(CPPFLAGS) $(CXXFLAGS) -MD -MP -fPIC -DPIC -pthread -Iinclude/wx/charts -std=c++11 `wx-config --cxxflags --libs` src/wxhistogramchartctrl.cpp
