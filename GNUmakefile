...
$(_builddir)wxcharts_wxchartspenandbrushoptions.o: src/wxchartspenandbrushoptions.cpp
	$(CXX) -c -o $@ $(CPPFLAGS) $(CXXFLAGS) -MD -MP -fPIC -DPIC -pthread -Iinclude/wx/charts -std=c++11 `wx-config --cxxflags --libs` src/wxchartspenandbrushoptions.cpp
